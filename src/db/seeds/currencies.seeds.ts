import CurrencyModel, { CurrencyAttributes } from "../models/currency.model";

const currencies: CurrencyAttributes[] = [
  {
    id: 1,
    symbol: "Lek",
    name: "AlbaniaLek",
...
const insert = async () => {
  await CurrencyModel.bulkCreate(currencies, { updateOnDuplicate: ["id"] });
};
